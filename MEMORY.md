...
- **15.08.2026 — тест синхронизации памяти после фикса.** Если видишь эту строку в GitHub, значит cron memory-sync.sh на Fornex реально пушит.
- тест 2: чистый прогон
