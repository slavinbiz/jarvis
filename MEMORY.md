...
- **Канал @santex_s_ai: никогда не упоминать VPN-бот в постах** (ни как кейс, ни как пример проекта) — попросил Вячеслав 08.08.2026, «могут быть проблемы» (вероятно из-за ограничений на рекламу VPN в РФ)
