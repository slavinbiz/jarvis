...
- **Канал @santex_s_ai: следить за расписанием публикаций и самому напоминать Вячеславу** (не ждать, пока спросит) — попросил 15.08.2026. Настроены авто-напоминания через скилл `reminder` на дни контент-плана (сб — дайджест, вт/чт — практика).
