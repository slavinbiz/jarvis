...
- Настройка: приложение ProtonVPN → Settings → Connection → Protocol → Stealth
- На момент записи ещё не подтверждено, что реально пробивает блокировку — уточнить у Вячеслава при следующем разговоре про VPN
